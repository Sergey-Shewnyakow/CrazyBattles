      ...
      content: Stack(alignment: Alignment.center, children: [
        ...
        cardsSectionNum == 1
            ? ExpandablePanel(
                ...
                title: SvgPicture.asset('../assets/images/icoSupport.svg',
                    fit: BoxFit.contain),
                content: ImageCarousel(
                  imageAssets: characterCards
                      .sublist((cardsSectionNum - 1) * 7, cardsSectionNum * 7)
                      .map((card) => card.asset)
                      .toList(),
            ...
            : cardsSectionNum == 2
                ? ExpandablePanel(
                    ...
                    title: SvgPicture.asset('../assets/images/icoDamagger.svg',
                        fit: BoxFit.contain),
                    content: ImageCarousel(
                      imageAssets: characterCards
                          .sublist(
                              (cardsSectionNum - 1) * 7, cardsSectionNum * 7)
                          .map((card) => card.asset)
                          .toList(),
                      sectionNumber: cardsSectionNum - 1,
                      pick: _selectCharacterCard,
