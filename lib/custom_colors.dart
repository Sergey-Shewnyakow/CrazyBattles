...
class CustomColors {
  ...
  static get dottedBorderLine => const Color.fromARGB(255, 139, 139, 139);//color of border of card socket
  static get mainBright => const Color.fromARGB(255, 134, 0, 255);//dominant color
